...
diseases_list = {15: 'Fungal infection', 4: 'Allergy', 16: 'GERD', 9: 'Chronic cholestasis', 14: 'Drug Reaction', 33: 'Peptic ulcer diseae', 1: 'AIDS', 12: 'Diabetes ', 17: 'Gastroenteritis', 6: 'Bronchial Asthma', 23: 'Hypertension ', 30: 'Migraine', 7: 'Cervical spondylosis', 32: 'Paralysis (brain hemorrhage)', 28: 'Jaundice', 29: 'Malaria', 8: 'Chicken pox', 11: 'Dengue', 37: 'Typhoid', 40: 'hepatitis A', 19: 'Hepatitis B', 20: 'Hepatitis C', 21: 'Hepatitis D', 22: 'Hepatitis E', 3: 'Alcoholic hepatitis', 27: 'Tuberculosis', 24: 'Common Cold', 36: 'Pneumonia', 18: 'Heart attack', 39: 'Varicose veins', 31: 'Psoriasis', 13: 'Impetigo'}

# Helper function to get predicted disease and related information
def helper(dis):
...
def get_predicted_value(symptoms):
    ...
    return diseases_list.get(predicted_value, "Unknown Disease")
...
def main():
    ...
    selected_symptoms = symptoms_input.split(', ')
    ...
    print(f"Precautions: {', '.join(precautions_list)}")
    print(f"Medications: {', '.join(medications_list)}")
    print(f"Diet Recommendations: {', '.join(diet_list)}")
    print(f"Workout Tips: {', '.join(workout_list)}")
